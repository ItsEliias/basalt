...
const styles = StyleSheet.create({
  ...
  wordmark: { fontFamily: mono, fontSize: 10, letterSpacing: 2.4, color: color.ink },
  kind: { fontFamily: mono, fontSize: 9.5, letterSpacing: 1.14, color: color.faint },
  ...
  scale: {
    fontFamily: mono, fontSize: 9, color: color.faint, borderBottomColor: color.faint,
  ...
  prReps: { fontFamily: mono, fontSize: 10, letterSpacing: 1.14, color: color.mute },
  ...
  wstatK: { fontFamily: mono, fontSize: 9, letterSpacing: 0.9, color: color.faint, marginBottom: 2 },
  wstatV: { fontFamily: mono, fontSize: 16, color: color.ink, fontVariant: ['tabular-nums'] },
  foot: { fontFamily: mono, fontSize: 8.5, letterSpacing: 0.85, color: color.faint, marginTop: 16, lineHeight: 13 },
});
