...
const styles = StyleSheet.create({
  ...
  close: { fontFamily: mono, fontSize: 10, letterSpacing: 1.2, color: color.faint },
  ...
  exName: { fontSize: 13, color: color.ink, marginBottom: 6 },
  targetRow: { flexDirection: 'row', gap: 8 },
  numLabel: { fontFamily: mono, fontSize: 9, letterSpacing: 0.9, color: color.faint, marginTop: 8, marginBottom: -4 },
  remove: { fontFamily: mono, fontSize: 8.5, letterSpacing: 0.85, color: color.faint, paddingTop: 4 },
  addExercise: { fontFamily: mono, fontSize: 10, letterSpacing: 1.2, color: color.mute, paddingVertical: 12, textAlign: 'center' },
});
